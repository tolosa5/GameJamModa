...
public class BotController : MonoBehaviour
{
    ...
    public float distanceThreshold = 1.1f; // Umbral de distancia para determinar si ha llegado al destino.
    ...
    {
        // MOVIMIENTO INICIAL
        if (contants.Ismoving == false && Vector3.Distance(transform.position, Origen.position) < distanceThreshold)
        {
